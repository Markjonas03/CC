...
<div class="modal fade" id="ad_modal<?php echo $row['id']?>" aria-hidden="true" data-bs-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="admin-act-ad.php">
        ...
        <div class="modal-footer">
          <button type="submit" name="admin-update-ad" class="btn btn-success btn-sm">Save Changes</button>
...
<div class="modal fade" id="ads_modal<?php echo $row['id']?>" aria-hidden="true" data-bs-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="admin-act-ad.php">
        <div class="modal-body">
        ...
        <div class="modal-footer">
          <button type="submit" name="admin-delete-ad" class="btn btn-success btn-sm">Yes</button>
