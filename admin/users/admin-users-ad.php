      ...
      <ul class="sidebar-nav" id="sidebar-nav">
         ...
         <li class="nav-item">
            ...
            <ul id="users-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
               ...
               <li> 
                  <a href="admin-users-ad.php" class="active"> 
               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <div class="card admin-users overflow-auto">   
                        <div class="card-body">
                           <h5 class="card-title">Total Users <span>| Admin</span></h5>
                           ...
                           <table class="table table-borderless datatable">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="#" class="text-info me-3" data-bs-target="#ad_modal<?php echo $row['id']?>" data-bs-toggle="modal"><i class="fa-solid fa-pen-to-square fs-5"></i></a>
                                       <a href="#" class="text-danger me-3" data-bs-target="#ads_modal<?php echo $row['id']?>" data-bs-toggle="modal"><i class="fa-solid fa-trash fs-5"></i></a>
                                    </td>
                                 </tr>
                                 <?php
                                       include 'admin-ad-modal.php';
                                       $no++;
                                       }
                                    }
                                 }
