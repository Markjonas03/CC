      ...
      <ul class="sidebar-nav" id="sidebar-nav">
         ...
         <li class="nav-item">
            ...
            <ul id="users-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
               <li> 
                  <a href="admin-users-stud.php" class="active"> 
               ...
               <div class="row">
                  <div class="col-12">
                     ...
                     <div class="card admin-users overflow-auto">
                        <div class="card-body">
                           <h5 class="card-title">Total Users <span>| Student</span></h5>
                           ...
                           <table class="table table-borderless datatable">
                              ...
                              <tbody>
                                 <?php
                                    $query = "SELECT * FROM tbl_users WHERE role = 'student'";
                                    $result = mysqli_query($conn,$query);
                                    if($result){
                                       if(mysqli_num_rows($result) > 0){
                                          $no = 1;
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="#" class="text-info me-3" data-bs-target="#stud_modal<?php echo $row['id']?>" data-bs-toggle="modal"><i class="fa-solid fa-pen-to-square fs-5"></i></a>
                                       <a href="#" class="text-danger me-3" data-bs-target="#studs_modal<?php echo $row['id']?>" data-bs-toggle="modal"><i class="fa-solid fa-trash fs-5"></i></a>
                                    </td>
                                 </tr>
                                 <?php
                                       include 'admin-stud-modal.php';
                                       $no++;
                                       }
                                    }
                                 }
